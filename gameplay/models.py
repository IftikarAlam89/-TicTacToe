...
class Game(models.Model):
    ...
    def board(self):
        """Return a two dimensional list of Move objects,
...
class Move(models.Model):
    #inherits from models.Model in django.db
    ...
    cooment=models.CharField(max_length=300,blank=True)
